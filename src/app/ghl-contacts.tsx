  ...
  return (
    <View style={s.root}>
      ...
      <FlatList
        ...
        ListFooterComponent={
          loading ? <ActivityIndicator color={C.green} style={{ padding: 20 }} /> : null
        }
        onEndReached={() => {
...
const s = StyleSheet.create({
  ...
  loadingRoot: { flex: 1, backgroundColor: C.bg, alignItems: "center", justifyContent: "center", padding: 32 },
  ...
  addBtn: { backgroundColor: C.green, paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20 },
  ...
  errorBox: {
    ...
    borderColor: "rgba(214,69,69,0.3)", borderRadius: 10,
    marginHorizontal: 20, padding: 12, marginBottom: 8,
  },
  errorText: { fontSize: 13, color: C.error, flex: 1 },
  errorRetry: { fontSize: 13, color: C.green, fontWeight: "600" },
  ...
  contactAvatarText: { fontSize: 16, fontWeight: "700", color: "#FFFFFF" },
  contactInfo: { flex: 1 },
  contactName: { fontSize: 15, fontWeight: "700", color: C.ink, marginBottom: 2 },
  ...
  tagText: { fontSize: 10, color: C.greenDark, fontWeight: "500" },
...
const fm = StyleSheet.create({
  ...
  title: { fontSize: 18, fontWeight: "800", color: C.ink, marginBottom: 20 },
  label: { fontSize: 13, fontWeight: "600", color: C.ink, marginBottom: 6 },
  input: {
    backgroundColor: C.inputBg, borderWidth: 1, borderColor: C.cardBorder,
    borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12,
    fontSize: 14, color: C.ink, marginBottom: 14,
  },
  ...
  addTagBtnText: { fontSize: 13, fontWeight: "700", color: "#FFFFFF" },
  ...
  tagText: { fontSize: 12, color: C.greenDark },
  saveBtn: {
    backgroundColor: C.green, paddingVertical: 15,
